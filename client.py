# from https://github.com/areed1192/interactive-broker-python-api/blob/master/ibw/clientportal.py
...
class IBClient():
    ...
    def run_scanner(self, instrument: str, scanner_type: str, location: str, size: str = '25',
